...
#    or
#   --server --app-file $$PIN_ROOT_DIR/apps/Chasm-app/tsi/-build_/lib/libChasm_app.so
#    (write the substitution manually)
...
#    or
#   --server --app-file $$PIN_ROOT_DIR/apps/Chasm-app/tsi/-build_/via-qtc/libChasm-app.so
#    (write the substitution manually)
