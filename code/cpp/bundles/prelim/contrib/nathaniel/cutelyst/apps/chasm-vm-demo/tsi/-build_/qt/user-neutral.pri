...
#    or
#   --server --app-file $$PIN_ROOT_DIR/apps/chasm-vm-demo/tsi/-build_/lib/libchasm_vm_demo.so
#    (write the substitution manually)

# working directory:
#   %{sourceDir}/../../../chasm-vm-demo
#    or
#   $$PIN_ROOT_DIR/apps/chasm-vm-demo/chasm-vm-demo
...
# command line arguments:
#   --server --app-file %{sourceDir}/../via-qtc/libchasm-vm-demo.so
#    or
#   --server --app-file $$PIN_ROOT_DIR/apps/chasm-vm-demo/tsi/-build_/via-qtc/libchasm-vm-demo.so
#    (write the substitution manually)
...
# THIS_APP_EXTRA_LIBS=$$PIN_ROOT_DIR/-build_/install/lib/cutelyst3-qt5-plugins/grantlee/5.3:${PIN_ROOT_DIR}/-build_/grantlee/install/lib
#
