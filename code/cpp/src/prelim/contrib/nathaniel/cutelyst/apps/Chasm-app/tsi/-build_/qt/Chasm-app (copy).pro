...
# /home/nlevisrael/Qt/5.15.2/gcc_64



#LD_LIBRARY_PATH=$QTDIR/lib:/home/nlevisrael/docker/gits/torq-wip/ar/code/cpp/src/prelim/contrib/nathaniel/cutelyst/-build_/via-qtc/lib/cutelyst3-qt5-plugins/grantlee/5.3:/home/nlevisrael/docker/gits/torq-wip/ar/code/cpp/src/prelim/contrib/nathaniel/cutelyst/-build_/grantlee/install/lib:${TSI_PIN_ROOT}/-build_/via-qtc/lib:$LD_LIBRARY_PATH
#TSI_PIN_ROOT=/home/nlevisrael/docker/gits/torq-wip/ar/code/cpp/src/prelim/contrib/nathaniel/cutelyst
...
PIN_ROOT_DIR = $$_PRO_FILE_PWD_
PIN_ROOT_DIR ~= s!/cutelyst/apps/.*!/cutelyst!

APPS_ROOT_DIR = $${PIN_ROOT_DIR}/apps
FRAMEWORK_ROOT_DIR = $${PIN_ROOT_DIR}/framework

message($$APPS_ROOT_DIR)
...
# command line arguments:
#   --server --app-file --server --app-file %{sourceDir}/../via-qtc/libChasm-app.so
# working directory:
#   %{sourceDir}/../../../Chasm-app
# add to the environment:
#   /home/nlevisrael/Qt/5.15.2/gcc_64/lib:%{sourceDir}/../../../../../-build_/via-qtc/lib:$LD_LIBRARY_PATH

# %{sourceDir}/../../../../../-build_/via-qtc/
# /home/nlevisrael/docker/gits/torq-wip/ar/code/cpp/src/prelim/contrib/nathaniel/cutelyst/apps/Chasm-app/tsi/-build_/qt/../../../../../-build_/via-qtc/lib
