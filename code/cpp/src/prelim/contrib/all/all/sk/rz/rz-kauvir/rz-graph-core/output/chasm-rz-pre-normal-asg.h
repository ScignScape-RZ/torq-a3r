...
#ifndef CHASM_RZ_PChasmRZ_NORMAL_ASG__H
#define CHASM_RZ_PChasmRZ_NORMAL_ASG__H
...
class ChasmRZ_Pchasm_rz_Normal_ASG : public ChasmRZ_ASG_Output
{
public:

#ifdef NO_CAON
 ChasmRZ_Pchasm_rz_Normal_ASG(ChasmRZ_Document* document);
#else
 ChasmRZ_Pchasm_rz_Normal_ASG(caon_ptr<ChasmRZ_Document> document);
#endif
...
#endif //CHASM_RZ_PChasmRZ_NORMAL_ASG__H
