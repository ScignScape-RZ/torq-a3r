...
#ifndef SVG_PDF_WEB_ENGINE_PAGE__H
#define SVG_PDF_WEB_ENGINE_PAGE__H
...
class SVG_PDF_Web_Engine_Page : public QWebEnginePage
{
 Q_OBJECT

public:
 SVG_PDF_Web_Engine_Page();
 SVG_PDF_Web_Engine_Page(SVG_PDF_Web_Engine_Page* parent);
