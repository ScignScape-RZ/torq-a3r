...
SVG_PDF_Web_Engine_View::SVG_PDF_Web_Engine_View(QDialog* parent_dialog)
...
bool SVG_PDF_Web_Engine_View::eventFilter(QObject *object, QEvent *event)
{
// if(page())
// {
//  if(page()->settings())
...
void SVG_PDF_Web_Engine_View::grab_snapshot(QWidget* full_size)
{
...
void SVG_PDF_Web_Engine_View::generate_context_menu(const QPoint& pos,
  n8 origin, Context_Menu_Info* cmi, QMouseEvent* mev)
{
 ...
 SVG_PDF_Web_Engine_Page* rpage = qobject_cast<SVG_PDF_Web_Engine_Page*>(this->page());
...
//  else
 ...
 void SVG_PDF_Web_Engine_View::check_sec()
 {
  if(sec)
  {
 ...
 void SVG_PDF_Web_Engine_View::mouseReleaseEvent(QMouseEvent* mouseEvent)
 {
  mouseEvent->ignore();
 }


 void SVG_PDF_Web_Engine_View::mousePressEvent(QMouseEvent* mev)
 {
 ...
 void SVG_PDF_Web_Engine_View::contextMenuEvent(QContextMenuEvent* event)
 {
  const QWebEngineContextMenuData& cd = page()->contextMenuData();
