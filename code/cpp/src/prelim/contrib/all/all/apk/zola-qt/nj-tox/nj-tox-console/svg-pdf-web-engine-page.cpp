                                                           ...
                                                           &url, NavigationType type, bool isMainFrame)
{
 ...
 SVG_PDF_Web_Engine_Page* wep = dynamic_cast<SVG_PDF_Web_Engine_Page*>(target);
...
SVG_PDF_Web_Engine_Page::SVG_PDF_Web_Engine_Page() : QWebEnginePage()
{

}

SVG_PDF_Web_Engine_Page::SVG_PDF_Web_Engine_Page(SVG_PDF_Web_Engine_Page* parent) : QWebEnginePage(parent)
{

}

//SVG_PDF_Web_Engine_Page::SVG_PDF_Web_Engine_Page():QWebEngineView()
//{
// sec  =  nullptr;
//}
...
SVG_PDF_Web_Engine_Page::createWindow(QWebEnginePage::WebWindowType type)
{
 qDebug()  << "WebWindowType" << type;
...
void SVG_PDF_Web_Engine_Page::emit_navRequest(const QUrl &url)
{
...
bool SVG_PDF_Web_Engine_Page::acceptNavigationRequest(const QUrl &url,
