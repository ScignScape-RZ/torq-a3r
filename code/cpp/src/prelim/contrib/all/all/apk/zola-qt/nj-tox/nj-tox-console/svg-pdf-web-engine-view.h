...
#ifndef SVG_PDF_WEB_ENGINE_VIEW__H
#define SVG_PDF_WEB_ENGINE_VIEW__H
...
class SVG_PDF_Web_Engine_View : public QWebEngineView
{
 Q_OBJECT
...
public:
 ...
 SVG_PDF_Web_Engine_View(QDialog* parent_dialog);
